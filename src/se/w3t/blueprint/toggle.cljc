...
(comp/defsc Toggle [this props]
  {}
  (dom/label
      {:class "relative inline-flex items-center cursor-pointer"}
    (dom/input {:type "checkbox", :value (:value props), :class "sr-only peer"
...
(def ui-toggle (comp/computed-factory Toggle))
